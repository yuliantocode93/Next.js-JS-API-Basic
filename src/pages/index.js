...
export default function Home() {
  ...
  return (
    <>
      <MetaHead title="Homex" description="Ini adalah halaman home" image={`${process.env.NEXT_PUBLIC_HOST_NAME}/images/logo/nike.svg`} url={process.env.NEXT_PUBLIC_HOST_NAME} />
          ...
          ? product?.map((value) => (
              ...
              >
                <div className="w-72 h-[265px] bg-red-50 flex-none">
                  <Image className="w-full h-[265px] object-cover bg-red-200" src={value.image} alt={value.title} width={500} height={500} />
                </div>
